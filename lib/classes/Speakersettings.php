...
class Speakersettings
{
    ...
    function speaker_menu_register() {
        ...
        $about_us = add_submenu_page('edit.php?post_type=speaker', __('Speaker Donations', SPEAKER_SLUG), __('Getting Started', SPEAKER_SLUG), 'administrator', 'donations', array($this, 'getting_started'));

        add_action('admin_print_styles-' . $page, array( $this,'speaker_style'));
        add_action('admin_print_scripts-'. $page, array( $this,'speaker_script'));
        add_action('admin_print_styles-' . $about_us, array($this, 'speaker_style'));
        add_action('admin_print_scripts-' . $about_us, array($this, 'speaker_script'));
        wp_enqueue_style( 'speaker_css_settings', $Speaker->assetsUrl . 'css/speakersettings.css');
