...
<div class="wrap">
    ...
    <div class="tlp-content-holder">
        <div class="tch-left">
            <form id="tlp-settings" onsubmit="speakerSettings(this); return false;">
                ...
                <table class="form-table">
                   ...
                   <!--  <tr>
                    ...
                    <tr>
                        <th scope="row"><label for="text-color"><?php _e('Text Color,Size & Align',SPEAKER_SLUG);?></label></th>
                        <td class="">
            ...
            <div>Make your Donations Here..!</div>
    ...
    <div class="tlp-help">
        ...
        <!-- <p class="tlp-help-link"><a class="button-primary" href="http://demo.radiustheme.com/wordpress/plugins/tlp-team/" target="_blank"><?php _e('Demo', SPEAKER_SLUG );?></a> <a class="button-primary" href="https://radiustheme.com/how-to-setup-configure-tlp-team-free-version-for-wordpress/" target="_blank"><?php _e('Documentation', SPEAKER_SLUG );?></a> </p> -->
    </div>
