...
<div class="wrap">
    ...
    <h2 class="page-heading"><?php _e('Speaker Settings', SPEAKER_SLUG);?></h2>
    <p><span style="font-weight: bold">
      <?php _e('See the "Getting Started" tab for instructions, or visit', SPEAKER_SLUG );?>
    </span><a class="button-primary" href="http://www.blackandwhitedigital.eu/symposium-speaker-profiles-plugin/speaker-documentation/" target="_blank">
    <?php _e('Documentation', SPEAKER_SLUG );?>
    </a></p>
    <div class="tlp-content-holder">
        <div class="tch-left">
            <form id="tlp-settings" onsubmit="speakerSettings(this); return false;">

                <h3 class="content-heading"><?php _e('General settings',SPEAKER_SLUG);?></h3>
    ...
    <div class="tlp-help">
                <p style="font-weight: bold">
                  <?php _e('Want more features?', SPEAKER_SLUG );?>
                </p>
                <p class="tlp-help-link"><a class="button-primary" href="http://www.blackandwhitedigital.eu/symposium-speaker-profiles-plugin/" target="_blank"><?php _e('Upgrade to Pro', SPEAKER_SLUG );?></a></p>
    </div>
